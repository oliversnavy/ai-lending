...
# Test a few specific strategies around B_high
strategies = {
    'B_high_0.05': lambda g, dp: min(max({'C': 0.30, 'D': 0.35, 'E': 0.35, 'F': 0.40, 'G': 0.40}.get(g, 0.21) + dp * 0.05, 0.21), 0.50),
    'B_high_0.08': lambda g, dp: min(max({'C': 0.30, 'D': 0.35, 'E': 0.35, 'F': 0.40, 'G': 0.40}.get(g, 0.21) + dp * 0.08, 0.21), 0.50),
    'B_high_0.10': lambda g, dp: min(max({'C': 0.30, 'D': 0.35, 'E': 0.35, 'F': 0.40, 'G': 0.40}.get(g, 0.21) + dp * 0.10, 0.21), 0.50),
    'B_higher': lambda g, dp: min(max({'C': 0.35, 'D': 0.40, 'E': 0.40, 'F': 0.45, 'G': 0.45}.get(g, 0.21) + dp * 0.05, 0.21), 0.50),
    'B_even_higher': lambda g, dp: min(max({'C': 0.40, 'D': 0.45, 'E': 0.45, 'F': 0.50, 'G': 0.50}.get(g, 0.21) + dp * 0.05, 0.21), 0.50),
    'B_lower': lambda g, dp: min(max({'C': 0.25, 'D': 0.30, 'E': 0.30, 'F': 0.35, 'G': 0.35}.get(g, 0.21) + dp * 0.10, 0.21), 0.50),
}
