...
# Try rates above 60% without capping
print("=== Rates above 60% (no cap) ===")
for rate in [0.65, 0.70, 0.75, 0.80, 0.90, 1.00]:
    ...
    print(f"rate={rate:.0%}: P&L=${total_pnl:,.0f}, Principal=${total_principal:,.0f}, Accept={accept_rate:.4%}, N={n_loans}")