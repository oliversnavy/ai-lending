...
results = {
    ...
    "acceptance_rate": round(accept_rate, 6),
    "loans_funded": int(n_loans),
    "total_principal": round(total_principal, 2),
    "approach": "Trained XGBoost default model on LendingClub training data, priced all loans at fixed 79% rate to maximize P&L per dollar while satisfying $15M capital cap and 400-loan volume floor.",
