...
# Try even higher k values
print("=== Higher k values ===")
for base_rate in [0.30, 0.35, 0.40]:
    for k in [3.5, 4.0, 5.0, 6.0, 8.0, 10.0]:
        ...
        print(f"base={base_rate:.0%}, k={k:.1f}: P&L=${total_pnl:,.0f}, Accept={accept_rate:.2%}, N={n_loans}")