...
feature_cols = ['fico_mid', 'dti', 'annual_inc', 'loan_amnt', 'funded_amnt',
    ...
    'chargeoff_within_12_mths', 'acc_open_past_24mths', 'num_tl_30dpd',
    'num_tl_120dpd_2m', 'num_tl_90g_dpd_24m', 'num_rev_tl_bal_gt_0',
    'num_actv_rev_tl', 'num_bc_tl', 'pct_tl_nvr_dlq', 'percent_bc_gt_75',
...
# Fill NaN with 0 for columns that are all NaN
for col in feature_cols:
    if medians[col] != medians[col]:  # check if NaN
        medians[col] = 0
